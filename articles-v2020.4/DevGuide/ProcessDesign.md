...
![processdesignguideimg1](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide1.jpg)
...
![processdesignguideimg2](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide2.jpg)

附登录功能流程如下（序列方式）：

![processdesignguideimg3](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide3.jpg)
...
![processdesignguideimg4](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide4.jpg)
 
从上图可见，不同的状态设置在不同的转换中，并在该转换下设置对应的登录操作，“未登录”转换如下图所示：

![processdesignguideimg5](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide5.jpg)

## 流程模板

云扩编辑器内置多种流程模板，通常我们在新建项目时选择 “企业流程模板”，该模板已包含了一个完整流程的基本模块：创建日志、环境初始化、数据初始化、主业务处理及结束处理，如下图所示：

![processdesignguideimg6](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide6.jpg)

![processdesignguideimg7](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide7.jpg)
...
- 用参数作为输入方式，流程运行时会弹出对话框让业务人员输入对应的值，如下图所示：
    ...
    ![processdesignguideimg9](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide9.jpg)
...
- 配置文件作为参数输入，通常推荐用Excel，在Excel中写入一些可能会变化的信息，如上面例子中的用户名、密码、文件路径等，在流程中需要设计读取Excel中输入信息的流程模块。当然具体需要填入哪些信息还要看实际的业务场景，我们只要掌握一个规律：**一些可能会变化的信息**用参数或者配置文件的方式输入，这不仅仅是指在本地会发生变化，也可能因为流程的迁移而导致的变化。
    ...
    ![processdesignguideimg10](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide10.jpg)
    ...
    ![processdesignguideimg11](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide11.jpg)
...
- 存入文件服务方式流程设计：用“上传文件”组件：（组件具体用法可参考文档
    [上传文件](https://academy.encoo.com/wiki/Activities/Console/FileUploadActivity.md?uuid=9729842b-6c29-4631-9da8-f7f10ac671e9))

    ![processdesignguideimg12](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide12.jpg)
...
- 存入本地Excel方式流程设计：用组件“打开/新建“、”写入区域“等（组件具体用法可参考[写入区域](https://academy.encoo.com/wiki/Activities/AppAutomation/OfficeExcel/WriteRange.md?uuid=967a43d8-af97-482b-ac04-610fe81511f2))
    ...
    ![processdesignguideimg13](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide13.jpg)
...
- 存入数据库方式流程设计：用组件”连接数据库“、”执行语句“、”插入语句“等（组件具体用法可参考[连接数据库](https://academy.encoo.com/wiki/Activities/Database/ConnectDatabase.md?uuid=15796251-0ca5-4e33-ba9a-d5ccd5a9752b))
    ...
    ![processdesignguideimg14](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide14.jpg)
...
- 参数类型设置为Password：
    ...
    ![processdesignguideimg15](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide15.jpg)

- 使用”输入密码“组件：

    ![processdesignguideimg16](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide16.jpg)

- 使用控制台”资产管理“功能进行加密，操作步骤如下：

    - 从编辑器发布流程至控制台（具体操作方式可参考：[发布自动化项目](https://academy.encoo.com/zh-cn/wiki/Studio/process/PublishProject.md?uuid=6c8d9220-3c6b-4597-ae3a-4f0b1d47fa16)）
 
    - 新建资产(具体操作方式可参考:[管理资产](https://academy.encoo.com/zh-cn/wiki/Console/v3.0.x/datacentor/asset/manageAsset.md?uuid=495cb5c0-d2dd-4fbb-a30a-344de946d855))

    - 流程部署（具体操作方式可参考：[流程部署](https://academy.encoo.com/zh-cn/wiki/Console/rpa-center/workflow/manageworkflow.md?uuid=7d5482f3-ccac-4283-9900-64040030a346))
...
![processdesignguideimg17](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide17.jpg)

那么什么情况下应该写业务日志？

- 正常的业务记录日志建议使用Info，针对某些已知的问题（不需要抛出错误），例如没有数据时下载按钮不可见，可以写入日志，以方便后续业务核对。

    ![processdesignguideimg18](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide18.jpg)

- 异常的错误建议使用Error，针对某些未知的错误，例如Catches中的异常，可以把异常日志exception.Message+exception.StackTrace进行输出

    ![processdesignguideimg19](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide19.jpg)
...
![processdesignguideimg20](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide20.jpg)

方法2：开始 - 设置 - 项目，勾选【保存运行、调试日志】，打开目录下的日志文件夹

![processdesignguideimg21](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide21.jpg)
...
![processdesignguideimg22](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide22.jpg)


点击日志打开文件夹：

![processdesignguideimg22-1](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide22-1.png)
...
![processdesignguideimg23](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide23.jpg)
...
- 短信方式，目前较多用于银行和政府，相对比较正式，实时性强，而且即使在没有流量的时候依然可以顺利接收

- 邮件方式，使用比较广泛，可以发送/抄送给不同的用户，还可携带附件，可以很好进行追溯

- 钉钉方式，需要企业中使用钉钉作为沟通工具，实时性强，一般作为通知来使用，比如流程需要人工介入，需要及时在钉钉中进行反馈。或者流程运行成功或者失败，也可以及时通知到用户

- 企业微信方式，需要企业中使用企业微信作为沟通工具，说明可参考钉钉方式
...
![processdesignguideimg26](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide26.jpg)
...
- Try中放入整体流程，若try中出现异常，则会进入Catch（可以多个catch 同时存在），在此可以打印日志并通知提示用户出错了，打印消息可参考：exception.Message+exception.StackTrace
    ...
    ![processdesignguideimg29](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide29.jpg)

- Finally可选，若需要可在Finally中释放资源
    
    ![processdesignguideimg30](https://docimages.blob.core.chinacloudapi.cn/images/DeveloperGuide/processondesignguide30.jpg)
