...
其中，图像元素利用图片对比完成匹配，而CV元素利用**计算机视觉模型**对目标区域进行分割，并根据**描述符**信息完成匹配。 
...
[CV组件使用链接](CV组件使用链接：https://academy.encoo.com/zh-cn/wiki/Activities/ComputerVision/assign-cv-window.md?_v=v2020.1&uuid=11acb9ad-2005-472f-a2ad-3072e07f0614)
