...
<video controls height='100%' width='100%' src="https://encooacademy.oss-cn-shanghai.aliyuncs.com/activity/Filter.mp4"></video>
...
- **工作表** ：执行筛选的目标工作表。
- **列号** ：执行筛选的目标列，数字或字母形式的列号，如，1、2、3、A、B、C等。
