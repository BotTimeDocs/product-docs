...
6. 支持切换 [激活](../Studio/quickStart/Activation.md) 方式：在关于页面实现个人版/企业版编辑器激活方式的切换以便重新激活。
...
2020.07.17 发布了云扩 RPA 编辑器和机器人，本次发布的编辑器和机器人的版本号分别是：
...
2020.06.16 发布了云扩 RPA 编辑器和机器人，本次发布的编辑器和机器人的版本号分别是：
...
2020.05.21 发布了云扩 RPA 编辑器和机器人，本次发布的编辑器和机器人的版本号分别是：
