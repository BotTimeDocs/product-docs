...
1. 进入 **应用开发** 的编辑模式。
2. 从左侧组件面板中选择 **输入组件** 下的 **多行文本框** 组件，拖拽至画布中。
3. 设置以下属性来查看显示效果。

    ![多行文本框配置项](https://docimages.blob.core.chinacloudapi.cn/images/Kris/Apps/textarea20210412.png)
