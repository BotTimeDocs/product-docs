...
### Q15：使用远程桌面运行自动化流程，最小化远程桌面窗口后自动化流程就会运行失败
 
<font color=5a6877> 【解决办法A_300016】:这是因为自动化流程必须以窗口元素进行定位，最小化窗口后就无法获取到元素的位置，进而运行失败。所以在远程桌面运行自动化流程时必须保证远程桌面窗口化，如果不想看到运行过程可以把窗口拖到屏幕边缘或是其他窗口后方。
...
<font color=5a6877> 【解决方法A4_00001】:
...
<font color=5a6877> 【解决方法A5_00001】:如果控制台的系统设置中没有流程日志清理功能，可升级至最新版控制台。如暂时无法升级，但日志文件过大，可手动执行以下脚本处理：
