...
1. 通过是否激活许可证来控制左侧菜单显示与隐藏，提高系统安全性。
2. 机器人创建之后，默认内置“部门功能管理员” 角色，可在”组织架构管理 > 数据权限配置 > 机器人权限 > 查看当前部门机器人权限“中查看，便于管理部门机器人权限。
3. 控制台 V4 版本支持社区版，方便用户试用。
4. 新增 [用户管理](./Console/v4.0.x/management/usersmanagement.md)、[角色管理](./Console/v4.0.x/management/rolesmanagement.md) 模块，使之与组织架构管理模块进行关联，完善组织架构及权限管理功能，方便管理员管理公司组织架构权限等信息。
...
1. 优化“流程包管理”列表页面，支持按“流程包名称”字段进行模糊查询，提升用户使用体验。
2. 优化“流程部署”模块，提升用户使用体验。

    - 新建“流程部署”时，支持添加邮箱地址，以便流程执行失败时通知相关人员
    - 新建“流程部署”时，可选择“无可用机器人时”的处理方式，如，“等待”、“取消任务”等
    - 在“流程部署”列表页面中，支持按照时间字段进行排序，同时支持按照流程部署名称模糊查询
    - 在“流程部署”列表页面中，新增批量操作功能，支持批量更新绑定的流程包版本和批量执行流程操作
    - 丰富“流程部署”列表页面的字段信息，新增“创建人”字段，同时在“流程部署”详情页面的“基本信息”中，新增“创建者”、“创建时间”、“更新者”、“更新时间”、“流程部署 Id”字段

3. 优化”机器人管理“模块，提升用户体验。

    - 新建机器人时，支持按需选择”固定许可证“和”浮动许可证“类型，满足不同用户使用场景
    - 丰富“机器人管理”列表页面的字段信息，新增“创建人”字段，同时在“机器人管理”详情页面的“基本信息”中，新增“创建者”、“创建时间”、“更新者”、“更新时间”字段
    - 在“机器人管理”详情页面，新增“任务记录”选项页，以查看当前机器人相关的任务记录
    - 在“机器人管理”详情页面，新增“实时状态检测”、“预警配置”选项页，以方便配置和实时监控机器人所在的电脑的 CPU、内存等使用情况

4. 优化”调试队列“模块，提升用户体验。

    - 在“调度队列”列表页面，支持按“队列名称”或“备注”字段进行模糊查询，支持时间字段进行排序
    - 丰富“调度队列”列表页面的字段信息，新增“创建人”字段，同时在“调度队列”详情页面的“基本信息”中，新增“创建者”、“创建时间”、“更新者”、“更新时间”字段

5. 优化“任务记录”模块，提升用户使用体验。

    - 在“任务记录”列表页面中，增加“刷新”按钮，可以手动刷新任务记录列表
    - 在“任务记录”列表页面中，支持按指定的时间筛选字段进行筛选任务记录
    - 丰富“任务记录”列表页面的字段信息，新增“发起人”字段，同时在“任务记录”详情页面的“基本信息”中，新增“发起人”、“更新者”、“更新时间”字段
