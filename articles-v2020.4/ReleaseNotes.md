...
2. 【编辑器】优化在线咨询，增加在线咨询入口
3. 【机器人】优化安装/升级体验
4. 非管理员权限运行编辑器时，元素识别时高亮外层窗体，并在点击时提示
5. UIA3识别钉钉
6. 选择器编辑器界面优化
7. 界面自动化组件支持即刻优雅终止流程
8. 界面自动化下组件全部新增超时属性
9. 获取含OCR文本元素，判断OCR文本是否存在组件的文本属性支持正则表达式
10. 选择器编辑器Java应用的Name属性全部层级支持通配符
11. UiAutomation DLL解除IDE依赖
