...
2. 支持单独调试或运行 .xaml 流程文件。
3. 支持使用编辑器直接发布自动化项目到本地机器人。
4. 在编辑器右下角支持浮窗通知。
...
#### 【编辑器】
1. 调试时，在变量面板支持查看值的详细信息。
2. 新建项目时支持选择桌面录制技术 UIA/UIA3。
3. 支持删除命名空间。
4. 支持设置运行时是否最小化编辑器主界面。
