...
4. 支持创建元素项目，支持将元素项目发布到元素市场，流程项目支持使用元素项目
...
1. 支持创建指定流程执行的快捷方式至桌面
2. 在“正在执行”界面，支持以流程目录树的形式查看流程的执行进度
3. 支持对正在执行流程进行暂停/继续操作

#### 【控制台】

1. 在“数据中心”中，新增“数据队列”模块，用于存储大量的消息，通常用于可积压可异步处理的工作场景
2. 在“机器人管理详情”页的“计算机监控”选项页中，支持远程控制单个或多个机器人桌面
3. 在“机器人管理”页，支持远程升级单个和多个机器人软件的版本
