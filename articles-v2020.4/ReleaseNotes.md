...
2023.3.2 发布了云扩 RPA , 本次发布的产品及版本号为：
...
1. 将选择器从xaml文件中分离，提升项目加载速度详见文档[选择器改动](https://academy.encoo.com/wiki/Activities/Appendix/selectorup.md)；
