...
1. 增加Excel组件[设置边框](../../TableExcelWPS/SetRangeBorder.md)，支持对单元格或区域设置字体；
2. 增加文本组件[移除空格](../../DataProcessing/TextProcessing/RemoveWhitespace.md)，支持去除字符串中的空格；
