...
点击[此处](../Appendix/SupportedAttribute.md?_v=Community)查看桌面元素和Web元素所支持的属性集合
...
目标
- **[选择器](../Appendix/Selector.md?_v=Community)** ：要进行属性校验的元素的选择器表达式，可通过“指定元素”自动生成，同时可支持修改。此属性和控件元素属性两者互斥且必选一填写
